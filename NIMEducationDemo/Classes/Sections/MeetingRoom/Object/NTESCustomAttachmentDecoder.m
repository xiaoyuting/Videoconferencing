    ...
    if (data) {
        ...
        if ([dict isKindOfClass:[NSDictionary class]])
        {
            ...
            switch (type) {
                ...
                {
                    attachment = [[NTESMeetingControlAttachment alloc] init];
                    ((NTESMeetingControlAttachment *)attachment).roomID = [data jsonString:CMRoomID];
                    ((NTESMeetingControlAttachment *)attachment).command = [data jsonInteger:CMCommand];
                    ((NTESMeetingControlAttachment *)attachment).uids = [data jsonArray:CMUIDs];
...
- (BOOL)checkAttachment:(id<NIMCustomAttachment>)attachment{
    ...
    else if ([attachment isKindOfClass:[NTESMeetingControlAttachment class]]) {
        return YES;
    }
    return check;
}
